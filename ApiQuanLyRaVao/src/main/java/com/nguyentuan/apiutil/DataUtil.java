...
public class DataUtil {
	...
	public static String convertCharacter(String input) {
		...
		String[] aList = { "Ã ", "Ã¡", "áº£", "Ã£", "áº¡", "Ã¢", "áº§", "áº¥", "áº©", "áº«", "áº­", "Äƒ", "áº±", "áº¯",
				"áº³", "áºµ", "áº·" };
		String[] eList = { "Ã¨", "Ã©", "áº»", "áº½", "áº¹", "Ãª", "á»�", "áº¿", "á»ƒ", "á»…", "á»‡" };
		String[] iList = { "Ã¬", "Ã­", "á»‰", "Ä©", "á»‹" };
		String[] oList = { "Ã²", "Ã³", "á»�", "Ãµ", "á»�", "Ã´", "á»“", "á»‘", "á»•", "á»—", "á»™", "Æ¡", "á»�", "á»›",
				"á»Ÿ", "á»¡", "á»£" };
		String[] uList = { "Ã¹", "Ãº", "á»§", "Å©", "á»¥", "Æ°", "á»«", "á»©", "á»­", "á»¯", "á»±" };
		String[] yList = { "Ã½", "á»³", "á»·", "á»¹", "á»µ" };
		String[] AList = { "Ã€", "Ã�", "áº¢", "Ãƒ", "áº ", "Ã‚", "áº¦", "áº¤", "áº¨", "áºª", "áº¬", "Ä‚", "áº°", "áº®",
				"áº²", "áº´", "áº¶" };
		String[] EList = { "Ãˆ", "Ã‰", "áºº", "áº¼", "áº¸", "ÃŠ", "á»€", "áº¾", "á»‚", "á»„", "á»†" };
		String[] IList = { "ÃŒ", "Ã�", "á»ˆ", "Ä¨", "á»Š" };
		String[] OList = { "Ã’", "Ã“", "á»Ž", "Ã•", "á»Œ", "Ã”", "á»’", "á»�", "á»”", "á»–", "á»˜", "Æ ", "á»œ", "á»š",
				"á»ž", "á» ", "á»¢" };
	...
	public static String converDateToString(Timestamp time, String format) {
		if (time == null) {
			return "";
		}
		SimpleDateFormat ddMMYYYY = new SimpleDateFormat(format);
		return ddMMYYYY.format(time);
	}
	
	public static String converDateToStringTime(String string, String format) {
		if (string == null) {
			return "";
		}
		SimpleDateFormat ddMMYYYY = new SimpleDateFormat(format);
		return ddMMYYYY.format(string);
	}
